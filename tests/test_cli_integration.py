...
class TestCLIIntegration:
    ...
    def test_info_command(self, cli_runner, sample_netcdf_files):
        ...
        assert (
            "Available Data" in result.stdout or "Climate Zarr Toolkit" in result.stdout
        )

    def test_create_zarr_no_interactive(
        self, cli_runner, sample_netcdf_files, zarr_output_dir
    ):
    ...
    def test_create_zarr_with_region_clipping(
        self, cli_runner, sample_netcdf_files, zarr_output_dir
    ):
    ...
    def test_county_stats_no_interactive(
        self, cli_runner, sample_netcdf_files, sample_shapefile, stats_output_dir
    ):
